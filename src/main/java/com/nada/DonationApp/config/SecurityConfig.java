package com.nada.DonationApp.config;

import com.nada.DonationApp.service.auth.CustomUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public static final String DONATION_PATH= "/api/v1/donation/**";
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers(DONATION_PATH).hasAuthority("user")
